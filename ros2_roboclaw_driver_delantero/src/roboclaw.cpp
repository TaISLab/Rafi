...
#include "ros2_roboclaw_driver_delantero/srv/reset_encoders.hpp"
...
RoboClaw::RoboClaw(const TPIDQ m1Pid, const TPIDQ m2Pid, float m1MaxCurrent,
  ...
  ros2_roboclaw_driver_delantero::srv::ResetEncoders::Request resetRequest;
  resetRequest.left = 0;
  resetRequest.right = 0;
  ros2_roboclaw_driver_delantero::srv::ResetEncoders::Response response;
...
bool RoboClaw::resetEncoders(
    ros2_roboclaw_driver_delantero::srv::ResetEncoders::Request &request,
    ros2_roboclaw_driver_delantero::srv::ResetEncoders::Response &response) {
  try {
