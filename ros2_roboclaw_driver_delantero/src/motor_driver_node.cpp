...
#include "ros2_roboclaw_driver_delantero/msg/robo_claw_status.hpp"
#include "roboclaw.h"
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::Publisher<ros2_roboclaw_driver_delantero::msg::RoboClawStatus>::SharedPtr statusPublisher = node->create_publisher<ros2_roboclaw_driver_delantero::msg::RoboClawStatus>(statusTopicName, qos);

  ros2_roboclaw_driver_delantero::msg::RoboClawStatus roboClawStatus;
