...
#include "ros2_roboclaw_driver_trasero/msg/robo_claw_status.hpp"
#include "roboclaw.h"
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::Publisher<ros2_roboclaw_driver_trasero::msg::RoboClawStatus>::SharedPtr statusPublisher = node->create_publisher<ros2_roboclaw_driver_trasero::msg::RoboClawStatus>(statusTopicName, qos);

  ros2_roboclaw_driver_trasero::msg::RoboClawStatus roboClawStatus;
